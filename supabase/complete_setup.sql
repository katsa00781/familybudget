...
CREATE TABLE IF NOT EXISTS salary_calculations (
    ...
    tizenket_oras_muszak DECIMAL(6,2) NOT NULL DEFAULT 0,
    pihenonapi_tulora_orak DECIMAL(6,2) NOT NULL DEFAULT 0,
    munkaszuneti_tulora_orak DECIMAL(6,2) NOT NULL DEFAULT 0,
