...
import { User as UserIcon, Mail, Phone, MapPin, Calendar, Save, Camera } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-white mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold">Felhasználói Profil</h1>
          </div>
          <p className="text-lg">
            Itt szerkesztheted a személyes adataidat és beállításaidat.
          </p>
        </div>
